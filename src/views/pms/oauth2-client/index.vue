  ...
  <CommonPage>
    ...
    <MeModal ref="modalRef" width="600px">
      ...
      >
        ...
        >
          <n-input v-model:value="modalForm.clientId" />
        </n-form-item>
        <n-form-item
          label="客户端名称"
          path="clientName"
...
const authorizationGrantTypes = reactive([
  ...
  {
    label: 'urn:ietf:params:oauth:grant-type:sms_code',
    key: 'SMS_CODE',
    value: 'urn:ietf:params:oauth:grant-type:sms_code',
    grantTypeName: 'urn:ietf:params:oauth:grant-type:sms_code',
  },
])
