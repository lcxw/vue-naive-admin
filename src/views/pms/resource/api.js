...
export default {
  getMenuTree: () => request.get('/oidc-server/permission/permissionTree?excludeButton=true'),
  getButtons: ({ parentId }) => request.get(`/oidc-server/permission/buttons/${parentId}`),
