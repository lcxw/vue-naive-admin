...
import { deviceVerification } from '@/views/oauth2/login/index.js'
import { getQueryString } from '@/utils/oauth2/GlobalUtils.js'
...
<template>
  ...
  <main>
    ...
    <n-card>
      ...
      <n-button type="info" :loading="loading" strong block @click="submit">
        提交
      </n-button>
    </n-card>
  </main>
